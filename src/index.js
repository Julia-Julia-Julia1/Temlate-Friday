...
console.log('Hello Rolling scopess');
const data = [{
        id: 1,
...
window.onload = function () {
    ...
    // Работаем с Tags-ссылкой на html странице. Отследиь нажатие на тег. При помощи addEventListener. 
    // EventListener - вешается на родителя, а не на каждый тег. 
    addTagsClickHandler();
